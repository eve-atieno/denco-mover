            ...
            <div className="px-6">
              <div className="flex flex-wrap justify-center">
                <div className="rounded-t-lg h-32 overflow-hidden">
                  <img className="object-cover w-20 w-full" src="https://le-cdn.hibuwebsites.com/aeb1d9b09e1b4b938adfa73d1d08351c/dms3rep/multi/opt/Office-86fb027e-396w.jpg" alt="Mountain" />
                </div>
              ...
              <div className="mt-10 py-10 border-t border-blueGray-200 text-center">
                <div className="flex flex-wrap ">
                  <div className="w-full lg:w-9/12">
                    <h3 className="text-3xl font-serif leading-normal mb-2 text-blueGray-700 dark:text-blueGray-200">My Bookings</h3>
                    <p className="text-lg font-serif leading-relaxed mt-4 mb-4 text-blueGray-600 dark:text-blueGray-400">Your booking details are below</p>
                    <div className="">
                      <div className="">
